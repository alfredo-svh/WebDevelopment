...
$(function(){
	...
	//Add class to menu
	$('body.conference .mainNavigation a:contains("Conference")').addClass('active');
	$('body.calendar .mainNavigation a:contains("Calendar")').addClass('active');
	$('body.speakers .mainNavigation a:contains("Guest speakers")').addClass('active');
	...
	// Colorbox
	$('.speaker-info').colorbox({inline: true, width: "50%"});
